package spring_boot_base.spring_boot_base.infra.functions.api;
...
import spring_boot_base.spring_boot_base.SpringBootBaseApplication;
    ...
    try {
      ...
      handler =
          new SpringBootProxyHandlerBuilder<HttpApiV2ProxyRequest>()
              ...
              .servletApplication()
              .springBootApplication(SpringBootBaseApplication.class)
              .buildAndInitialize();
